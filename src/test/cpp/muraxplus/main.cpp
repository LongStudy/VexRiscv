#include "VMuraxPlus.h"
#include "VMuraxPlus_MuraxPlus.h"
#include "verilated.h"
...
class MuraxPlusWorkspace : public Workspace<VMuraxPlus>{
public:
	MuraxPlusWorkspace() : Workspace("MuraxPlus"){
